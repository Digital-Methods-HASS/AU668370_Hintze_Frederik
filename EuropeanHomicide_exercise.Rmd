...
Ok, the data looks good except for the column `Homicide rate in Europe over long-term (per 100,000)` which is not very easy to work with.
...
ggplot(data =kongeplotting, aes(x = midyear, y = duration)) + 
  geom_col(alpha=0.5)+
  geom_smooth()+
  labs(title="Danish kings duration of ruling",
         x="Danish kings",
         y="years of ruling")
...
The data visualization of murder rates shows, that we are killing each other a lot less than we used to. Especially if you compare the 20th with the 15th cenutry. 
